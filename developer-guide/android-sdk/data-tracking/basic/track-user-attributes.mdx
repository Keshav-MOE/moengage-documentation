...
For setting other User Attributes, use the generic method **setUserAttribute(key, value).** Supported types for attribute value are `String`, `Int`, `Long`, `Double`, `Float`, `Boolean`, `Date`, `GeoLocation`, `JSONObject`, and `JSONArray`.
