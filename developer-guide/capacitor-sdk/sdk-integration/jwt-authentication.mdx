...
You can enable JWT authentication during [SDK initialization]() by configuring the [**plaecholder**](placeholder for link).[**plaecholder**]() property on the [**plaecholder**]() object.
...
Register the [**placeholder**](placeholder) in a global scope, such as the [**placeholder] method of your AppDelegate class, to ensure your application always receives callbacks.
